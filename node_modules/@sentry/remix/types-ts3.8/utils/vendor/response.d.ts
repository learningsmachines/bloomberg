import { DeferredData, ErrorResponse, ReactRouterDomPkg, RouteMatch, ServerRoute } from './types';
/**
 ...
 */
export declare function matchServerRoutes(routes: ServerRoute[], pathname: string, pkg?: ReactRouterDomPkg): RouteMatch<ServerRoute>[] | null;
/**
 ...
 */
export declare function getRequestMatch(url: URL, matches: RouteMatch<ServerRoute>[]): RouteMatch<ServerRoute>;
/**
