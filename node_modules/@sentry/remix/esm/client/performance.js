 ...
 = {
  ...
  const SentryRoot = (props) => {
    ...
    if (!_useEffect || !_useLocation || !_useMatches || !_customStartTransaction) {
      ...
      return React.createElement(OrigApp, { ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 117}} );
    }
    ...
    // @ts-expect-error Setting more specific React Component typing for `R` generic above
    // will break advanced type inference done by react router params
    return React.createElement(OrigApp, { ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 168}} );
  };
