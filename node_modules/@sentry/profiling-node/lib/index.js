  ...
  "node_modules/@sentry/utils/cjs/object.js"(exports) {
    ...
    function addNonEnumerableProperty(obj, name, value) {
      try {
        ...
        (typeof __SENTRY_DEBUG__ === "undefined" || __SENTRY_DEBUG__) && logger5.logger.log(`Failed to add non-enumerable property "${name}" to object`, obj);
      }
    }
    ...
    function supportsNativeFetch() {
      ...
      if (doc && typeof doc.createElement === "function") {
        try {
          ...
          (typeof __SENTRY_DEBUG__ === "undefined" || __SENTRY_DEBUG__) && logger5.logger.warn("Could not create sandbox iframe for pure fetch check, bailing to window.fetch: ", err);
        }
      }
      return result;
    }
...
var require_instrument = __commonJS({
  "node_modules/@sentry/utils/cjs/instrument.js"(exports) {
    ...
    function instrument(type2) {
      ...
      switch (type2) {
        ...
        case "unhandledrejection":
          ...
          break;
        default:
          (typeof __SENTRY_DEBUG__ === "undefined" || __SENTRY_DEBUG__) && logger5.logger.warn("unknown instrumentation type:", type2);
          return;
      }
    }
    function addInstrumentationHandler(type2, callback) {
      handlers[type2] = handlers[type2] || [];
      handlers[type2].push(callback);
      instrument(type2);
    }
    ...
    function triggerHandlers(type2, data) {
      ...
      for (const handler of handlers[type2] || []) {
        try {
          handler(data);
        } catch (e) {
          (typeof __SENTRY_DEBUG__ === "undefined" || __SENTRY_DEBUG__) && logger5.logger.error(
          ...
          return function(type2, listener, options) {
            if (type2 === "click" || type2 == "keypress") {
              try {
                ...
                const handlerForType = handlers2[type2] = handlers2[type2] || { refCount: 0 };
    ...
    function objectToBaggageHeader(object) {
      ...
      return Object.entries(object).reduce((baggageHeader, [objectKey, objectValue], currentIndex) => {
        ...
        if (newBaggageHeader.length > MAX_BAGGAGE_STRING_LENGTH) {
          (typeof __SENTRY_DEBUG__ === "undefined" || __SENTRY_DEBUG__) && logger5.logger.warn(
