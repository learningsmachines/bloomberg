...
function createRequestHandler({
  ...
  return async (req, res, next) => {
    try {
      ...
      let criticalCss = mode === "production" ? null : res.locals.__remixDevCriticalCss;
      let response = await handleRequest(request, loadContext, criticalCss ? {
