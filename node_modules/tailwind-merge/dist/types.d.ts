...
declare function getDefaultConfig(): {
    ...
    readonly classGroups: {
         ...
         */
        readonly w: readonly [{
            readonly w: readonly ["auto", "min", "max", "fit", typeof isArbitraryValue, ThemeGetter];
        }];
        /**
         * Min-Width
         ...
         */
        readonly h: readonly [{
            readonly h: readonly [typeof isArbitraryValue, ThemeGetter, "auto", "min", "max", "fit"];
        }];
        /**
         * Min-Height
        ...
        readonly 'min-h': readonly [{
            readonly 'min-h': readonly ["min", "max", "fit", typeof isLength, typeof isArbitraryValue];
        }];
        /**
         * Max-Height
        ...
        readonly 'max-h': readonly [{
            readonly 'max-h': readonly [typeof isArbitraryValue, ThemeGetter, "min", "max", "fit"];
        }];
        /**
         * Font Size
...
export { type ClassNameValue, type Config, type DefaultClassGroupIds, type DefaultThemeGroupIds, createTailwindMerge, extendTailwindMerge, fromTheme, getDefaultConfig, mergeConfigs, twJoin, twMerge, validators_d as validators };
